...
b=18#float(input('Ingrese el base del canal: '))
z=2#float(input('Ingrese el talud : '))
so=0.001#float(input('Ingrese la pediente: '))
...
def GRAFICA():#aqui se incluyen las ecuuaciones que deseo graficar
    si=float(input('Ingrese 0=SistemaIngles  1=SistemaInternacional: '))
    y=3.45#float(input('Ingrese y inicial: '))
